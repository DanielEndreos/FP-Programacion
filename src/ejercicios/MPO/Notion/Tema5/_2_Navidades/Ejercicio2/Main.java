package ejercicios.MPO.Notion.Tema5._2_Navidades.Ejercicio2;

import ejercicios.MPO.Notion.Tema5._2_Navidades.Ejercicio2.model.Estudiante;
...
public class Main {
    static void main(String[] args) {
        ...
        */
        ...
        Estudiante e1 = new Estudiante("Daniel", 35, 7.0, 7.0, 9.0);
        Estudiante e2 = new Estudiante("Cristina", 35, 10.0, 10.0, 10.0);
        Estudiante e3 = new Estudiante("Adrián", 35, 2.0, 7.0, 4.0);
        e1.mostrarInforme();
        System.out.println("------");
        e2.mostrarInforme();
        System.out.println("------");
