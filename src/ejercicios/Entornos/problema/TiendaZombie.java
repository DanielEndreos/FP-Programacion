...
public class TiendaZombie {
    ...
    static void main(String[] args) {
        ...
        int op = -1;
        while(op != 0) {
            System.out.println("\n1 ver | 2 comprar | 3 add | 4 buscar | 5 informe | 0 salir");
                    op = Integer.parseInt(sc.nextLine());
            if(op == 1) {

                for(int i = 0; i< nombre.size(); i++){
                    System.out.println((i+1)+". "+ nombre.get(i)+" - "+ precio.get(i)+"€ - stock:"+ stock.get(i));
                }
            } else if(op == 2) {
                ...
                for(int i = 0; i< nombre.size(); i++){
                    if(nombre.get(i).toLowerCase().contains(t)) {
                        System.out.println("ENCONTRADO: "+ nombre.get(i)+" "+ precio.get(i)+"€ stock:"+ stock.get(i));
                ...
                System.out.println("Valor inventario: "+sum+"€ | unidades: "+totalStock);
            } else if(op == 0) {
